...
# square_min_x = min([t[0] for t in c]) // SCALE
# square_max_x = max([t[0] for t in c]) // SCALE
# square_min_y = min([t[1] for t in c]) // SCALE
# square_max_y = max([t[1] for t in c]) // SCALE

# draw.rectangle((square_min_x, square_min_y, square_max_x, square_max_y), outline='blue', width=3)
